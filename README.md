...
3. Браузер откроет новую вкладку с блоками отслеживаемых товаров: карточки выстроены по пять в ряд и выглядят так же, как во всплывающем окне. Здесь доступны те же действия: можно изменить порог уведомления, открыть карточку на Ozon, обновить цены и удалить позиции.
